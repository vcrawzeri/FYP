<x-app-layout>
    <div x-data="{
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- LEFT COLUMN: Profile Details (The taller card) --}}
            ...
            {{-- **FIX APPLIED HERE:** RIGHT COLUMN FLEX WRAPPER --}}
            {{-- This `div` acts as the grid item, and its internal flex behavior ensures it only takes the required height. --}}
            <div class="flex flex-col gap-6">

                {{-- RIGHT CARD 1: Update Password (The shorter card) --}}
                <div class="bg-white p-6 shadow rounded-lg">
                ...
                {{-- If you add more small cards, they will stack neatly here --}}
